// Objective-C
// Kept byte-for-byte identical to tmpl.c except for #import, the default key, and return 0
// (a full duplicate is nearly free for PPMC; gcc's Objective-C has no implicit return 0 at the end of main)

#import<stdio.h><QCConst>newline</QCConst>
