...
class qc{
  static void Main(string[]n){
    ...
    var z=n.Length>0?n[0]:"cs";
    // Put the name (the default key if no argument) into logical r0.. (store starts at 48, hence r[c%8])
    for(;c<z.Length;c++)
      r[c%8]=z[c];
    var o=System.Console.OpenStandardOutput();
    while(i<l){
      c=g[i];
      i+=1;
