...
#lang racket<QCConst>newline</QCConst>
...
(do()((= c 8))(vector-set! r(modulo c 8)(b(car(append(vector->list(current-command-line-arguments))(list "rkt")))c))(set! c(+ c 1)))
